...
import type { ChangeStatus, ChangeType, RiskLevel, DiffItem } from './types';
import { originalContract, newContract, diffItems as mockDiffItems } from './mockData';

const router = useRouter();

// State
const diffItems = ref<DiffItem[]>([...mockDiffItems]);
