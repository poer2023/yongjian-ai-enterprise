...
<template>
  <div class="bid-search-page">
    ...
    <section class="content-grid">
      ...
      <div class="subscription-card">
        <div class="card-header">
          <div class="header-left">
            ...
            <h2 class="card-title">标讯订阅</h2>
          </div>
          <button class="daily-report-btn" @click="navigateTo('bid-daily-report')">
            <ScrollText :size="14" />
            查看完整报告
          </button>
        </div>
        ...
        <div class="policy-tabs">
          <button
            class="policy-tab"
            :class="{ active: activePolicy === 'all' }"
            @click="activePolicy = 'all'"
          >
            全部
          </button>
          <button
            ...
            :key="group.id"
            class="policy-tab"
            :class="{ active: activePolicy === group.id }"
            @click="activePolicy = group.id"
          >
            {{ group.name }}
            <span class="tab-badge">{{ group.stats.newCount }}</span>
          </button>
        </div>
      ...
      <!-- 智能体推荐卡片 - AgentsView样式 -->
      <div class="agents-card">
        <div class="card-header">
          <div class="header-left">
            <div class="header-icon agents-icon">
              <Zap :size="20" />
            </div>
            <h2 class="card-title">投标智能体</h2>
          </div>
        </div>
        <div class="agents-grid">
          ...
          >
            <div class="agent-icon-box" :style="{ backgroundColor: agent.bgColor }">
